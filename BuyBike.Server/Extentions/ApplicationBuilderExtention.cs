    ...
    public static class ApplicationBuilderExtention
    {
        ...
        private static async Task SeedDataAsync(IMinIoRepository repo)
        {
            try
            {
                ...
                using (FileStream fs = File.OpenRead(@"Data/Pictures/bicycles/road/Allez E5_28_red.jpg"))
                {
                    var file = new FormFile(fs, 0, fs.Length, "Allez E5_28_red.jpg", fs.Name);

                    await repo.AddAsync("buy-bike", "bicycles/road/Allez E5_28_red.jpg", file);
                }
